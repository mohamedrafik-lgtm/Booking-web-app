    ...
    return (
        <form className="flex flex-col justify-center items-center w-full px-16 ">
            <div className="flex space-x-2 w-full">
               <div className="flex-1">
                   <input 
                       ...
                       id="firstName" 
                       name="firstName" 
                       className="border p-2 rounded-md w-full bg-orange-300/30 focus:outline-orange-300 text-white placeholder-white" 
               ...
               <div className="flex-1">
                   <input 
                       ...
                       id="lastName" 
                       name="lastName" 
                       className="border p-2 rounded-md w-full focus:outline-orange-300 bg-orange-300/30 text-white placeholder-white" 
            ...
            <div className="w-full mt-4">
                <button
                    type="submit"
                    className="text-base font-semibold p-2 rounded-md w-full mt-4 text-white bg-orange-300/50"
                >
                    Create Account
                </button>
            </div>
            ...
            <div className="w-full mt-4 flex space-x-4">
                <button
                    type="submit"
                    className="border p-2 rounded-md w-full mt-4 text-white flex items-center justify-center bg-orange-300/30">
                ...
                <button
                    type="submit"
                    className="border p-2 rounded-md w-full mt-4 flex items-center justify-center text-white bg-orange-300/30"
                >
